...
강의별 정리만으로 부족할 때는 뒤에 이어지는 핵심 암기표·전체 시험범위 암기 리스트·키워드 압축 카드를 활용한다.
...
> 용도: 전 과목 시험범위 전체를 한 번에 회독하기 위한 번호 리스트.
> 구성: 강의별 표가 아닌 과목별 순서 리스트. 설명성 개요는 제외하고 시험 포인트·핵심 정리·정답 감각 위주로 정리.
